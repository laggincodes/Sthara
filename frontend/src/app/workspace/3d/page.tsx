          ...
          <div className="w-72 shrink-0 border-r border-slate-800 bg-[#0B0F19]/90 p-4 space-y-4 overflow-y-auto z-10 select-none">
            ...
            <div className="space-y-2.5 text-xs font-mono">
              ...
              <div className="rounded-lg bg-slate-900/60 border border-slate-800/80 p-3 space-y-2">
                ...
                <div className="flex justify-between">
                  <span className="text-slate-400">Underground Data:</span>
              ...
              <div className="pt-2 space-y-1.5">
                <button
                  ...
                  className="w-full text-center py-2 px-3 rounded-lg bg-indigo-950/70 hover:bg-indigo-900 border border-indigo-500/40 text-indigo-300 text-xs font-semibold transition-colors cursor-pointer"
                >
                  {subView3D === "units" ? "← Return to Physical OSM Model" : "Open Synthetic Cadastral Benchmark (Units)"}
                </button>
                <Link
                  href="/data"
          ...
          <div className="w-80 shrink-0 border-l border-slate-800 bg-[#0B0F19]/90 p-4 space-y-4 overflow-y-auto z-10 select-none">
            ...
            {activeBuilding ? (
              <div className="space-y-3 text-xs font-mono">
                ...
                {/* 4. HIERARCHY & PROTOTYPE SPATIAL IDENTITY */}
