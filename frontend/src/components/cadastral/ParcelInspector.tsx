...
function BuildingHeightCard({
  ...
  return (
    <div className="rounded-lg border border-[#D7D4CB] bg-[#E9E5DA] p-2.5">
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-1.5">
          <span className="h-2 w-2 rounded-full bg-cyan-400" />
          <span className="text-[10px] font-mono uppercase text-[#62635D] font-semibold tracking-wider">
        ...
        <span
          className={`rounded border px-1.5 py-0.5 text-[9px] font-mono ${
            status === "AVAILABLE"
              ? "bg-emerald-950/60 border-emerald-500/30 text-[#788575]"
              : status === "INVALID"
              ? "bg-rose-950/60 border-rose-500/30 text-rose-400"
              : status === "INCONSISTENT"
              ? "bg-[#F8F6F0]mber-950/60 border-amber-500/30 text-amber-400"
              : "bg-[#E9E5DA] border-[#D7D4CB] text-[#62635D]"
          }`}
        >
          {status}
        </span>
      ...
      <div className="grid grid-cols-3 gap-2 py-1 border-b border-[#D7D4CB] mb-2">
        <div>
          <span className="text-[9px] font-mono text-[#77786F] block uppercase">Ground Elev</span>
          <span className="text-xs font-mono font-medium text-[#252622]">
            {groundElev !== null && groundElev !== undefined ? `${groundElev.toFixed(2)}m` : "Not available"}
          </span>
        </div>
        <div>
          <span className="text-[9px] font-mono text-[#77786F] block uppercase">Roof Elev</span>
        ...
        <div>
          <span className="text-[9px] font-mono text-[#77786F] block uppercase">Height (H)</span>
          <span className="text-sm font-bold font-mono text-[#A85D48]">
            {bldHeight !== null && bldHeight !== undefined ? `${bldHeight.toFixed(2)}m` : "Not available"}
          </span>
        </div>
      </div>

      <div className="flex items-center justify-between text-[10px] font-mono text-[#62635D] mb-2">
      ...
      {onCalculate && (
        <button
          ...
          className="w-full inline-flex items-center justify-center gap-1.5 rounded border border-[#DDBCB4] bg-cyan-950/30 py-1 px-2 text-[10px] font-mono font-medium text-[#A85D48] hover:bg-cyan-900/40 transition-colors disabled:opacity-50"
        >
          {isCalculating ? (
            <>
  ...
  return (
    <div className="rounded-lg border border-[#D7D4CB] bg-[#E9E5DA] p-2.5">
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex items-center gap-1.5">
          <span className="rounded bg-purple-950/60 border border-purple-500/30 px-1.5 py-0.5 text-[9px] font-mono text-[#B28A52]">
      ...
      {sortedFloors.length === 0 ? (
        <div className="py-2 text-center text-[#77786F] text-[11px] font-mono">
          <p>No floor stratification computed yet.</p>
          <p className="text-[10px] text-[#77786F] mt-0.5">
            {spec
            ...
            <div
              ...
              className={`flex items-center justify-between rounded border p-1.5 text-[10px] font-mono transition-colors ${
                fl.floor_index === 0
                  ...
                  : "border-[#D7D4CB] bg-[#E9E5DA] text-[#252622]"
              }`}
            >
              <div className="flex items-center gap-1.5 truncate">
                <span className="text-[9px] font-bold text-[#77786F] w-9 truncate">
                  FL-{fl.floor_index.toString().padStart(2, "0")}
                </span>
                <span className="font-medium text-[#252622] truncate">{fl.floor_name}</span>
              </div>
              <div className="flex items-center gap-2 text-right">
                <span className="text-[#62635D]">
                  {fl.base_elevation.toFixed(1)}m → {fl.top_elevation.toFixed(1)}m
                </span>
                <span className="rounded bg-[#E9E5DA] px-1 py-0.5 text-[9px] text-[#252622]">
      ...
      {floorData?.warnings && floorData.warnings.length > 0 && (
        <div className="rounded bg-[#F8F6F0]mber-950/40 border border-amber-500/30 p-1.5 mb-2 text-[10px] font-mono text-amber-300">
      ...
      {onGenerate && (
        <button
          ...
          className="w-full inline-flex items-center justify-center gap-1.5 rounded border border-purple-500/40 bg-purple-950/30 py-1 px-2 text-[10px] font-mono font-medium text-[#B28A52] hover:bg-purple-900/40 transition-colors disabled:opacity-50"
        >
          {isGenerating ? (
            <>
      ...
      <div className="mt-2 text-[9px] font-mono text-[#77786F] text-center">
...
function Building3DMeshCard({
    ...
    return (
      <div className="rounded-lg border border-[#D7D4CB] bg-[#E9E5DA] p-2.5">
        <div className="flex items-center justify-between mb-1.5">
          <div className="flex items-center gap-1.5">
            <span className="h-2 w-2 rounded-full bg-[#F3F0E8]lue-400" />
            <span className="text-[10px] font-mono uppercase text-[#62635D] font-semibold tracking-wider">
              3D Polyhedral Solid Mesh
            </span>
          </div>
          <span className="rounded border border-[#D7D4CB] bg-[#E9E5DA] px-1.5 py-0.5 text-[9px] font-mono text-[#62635D]">
  ...
  return (
    <div className="rounded-lg border border-blue-500/40 bg-[#F3F0E8]lue-950/20 p-2.5">
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-1.5">
          <span className="h-2 w-2 rounded-full bg-[#F3F0E8]lue-400 animate-pulse" />
        ...
        <div className="flex items-center gap-1">
          {collection.parts.length > 1 && (
            <span className="rounded border border-blue-500/30 bg-[#F3F0E8]lue-950/60 px-1.5 py-0.5 text-[9px] font-mono text-blue-300">
              {collection.parts.length} PARTS
            </span>
          )}
          <span className="rounded border border-emerald-500/30 bg-emerald-950/60 px-1.5 py-0.5 text-[9px] font-mono text-[#788575]">
            WATERTIGHT SOLID
          </span>
        </div>
      </div>

      <div className="grid grid-cols-2 gap-2 py-1 border-b border-[#D7D4CB] mb-2">
        <div>
          <span className="text-[9px] font-mono text-[#77786F] block uppercase">Enclosed Volume</span>
          <span className="text-sm font-bold font-mono text-[#A85D48]">
            {collection.total_volume_cubic_m?.toLocaleString() ?? "—"} m³
          </span>
        </div>
        <div>
          <span className="text-[9px] font-mono text-[#77786F] block uppercase">Surface Area</span>
          <span className="text-sm font-bold font-mono text-[#252622]">
            {collection.total_surface_area_sqm?.toLocaleString() ?? "—"} m²
          </span>
        </div>
      </div>

      <div className="grid grid-cols-2 gap-1.5 text-[10px] font-mono text-[#62635D] mb-2">
        <div>
          <span className="text-[#77786F]">Vertices:</span> {totalVertices}
        </div>
        <div>
          <span className="text-[#77786F]">Faces:</span> {totalFaces} tri
        </div>
        <div>
          <span className="text-[#77786F]">Base:</span> {building3D.building.base_elevation ?? "—"}m
        </div>
        <div>
          <span className="text-[#77786F]">Roof:</span> {building3D.building.top_elevation ?? "—"}m
        </div>
      </div>
      ...
      {onSwitchTo3D && (
        <button
          ...
          className="w-full inline-flex items-center justify-center gap-1.5 rounded border border-blue-500/40 bg-[#F3F0E8]lue-900/30 py-1.5 px-2 text-[10px] font-mono font-medium text-blue-300 hover:bg-[#F3F0E8]lue-800/40 transition-colors"
        >
...
function Floor3DVolumeCard({
  ...
  return (
    <div className="rounded-lg border border-[#DDBCB4] bg-cyan-950/20 p-2.5">
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-1.5">
          <span className="h-2 w-2 rounded-full bg-cyan-400 animate-pulse" />
          <span className="text-[10px] font-mono uppercase text-[#A85D48] font-semibold tracking-wider">
      ...
      <div className="grid grid-cols-2 gap-2 py-1 border-b border-[#D7D4CB] mb-2">
        <div>
          <span className="text-[9px] font-mono text-[#77786F] block uppercase">Stratified Volume</span>
          <span className="text-sm font-bold font-mono text-[#A85D48]">
            {totalVolume?.toLocaleString(undefined, { maximumFractionDigits: 1 })} m³
          </span>
        </div>
        <div>
          <span className="text-[9px] font-mono text-[#77786F] block uppercase">Total Surface</span>
          <span className="text-sm font-bold font-mono text-[#252622]">
            ...
            <div
              ...
              className={`p-2 rounded cursor-pointer transition-colors text-[10px] font-mono border ${
                isSelected
                  ...
                  : "bg-[#E9E5DA] hover:bg-[#E9E5DA] border-[#D7D4CB] text-[#252622]"
              }`}
            >
              ...
              <div className="grid grid-cols-2 gap-1 text-[9px] text-[#62635D] mb-1.5">
                <div>
                  <span className="text-[#77786F]">Floors:</span> {p.floor_ids.join(", ")}
                </div>
                <div>
                  <span className="text-[#77786F]">Vol:</span> {p.volume_cubic_m != null ? `${p.volume_cubic_m.toFixed(1)} m³` : "—"}
                </div>
                <div>
                  <span className="text-[#77786F]">Z-Span:</span> {p.base_elevation != null && p.top_elevation != null ? `${p.base_elevation.toFixed(1)}m – ${p.top_elevation.toFixed(1)}m` : "—"}
                </div>
                <div>
                  <span className="text-[#77786F]">Height:</span> {p.total_height != null ? `${p.total_height.toFixed(1)}m` : "—"}
                </div>
              </div>
              ...
              <div className="pt-1.5 border-t border-violet-800/40 mt-1">
                    ...
                    <span
                      className={`px-1 py-0.5 rounded text-[7px] font-bold uppercase border ${
                        ulpinInfo.identifier_status === "VALID"
                          ? "bg-emerald-950/70 text-[#788575] border-emerald-500/40"
                ...
                {ulpinInfo?.ulpin ? (
                  <div className="flex items-center justify-between gap-1 bg-[#E9E5DA]/90 p-1.5 rounded border border-violet-800/50">
                    <span
                      className="text-[9px] font-mono text-[#788575] truncate select-all tracking-tight"
  ...
  return (
    <div className="rounded-lg border border-[#DDBCB4] bg-cyan-950/20 p-2.5">
      <div className="flex items-center justify-between mb-2">
        ...
        <span className="rounded border border-[#DDBCB4] bg-cyan-950/60 px-1.5 py-0.5 text-[9px] font-mono text-[#A85D48]">
          STAGE 16 DOMAIN
        </span>
      </div>
          ...
          return (
            <button
              ...
              className={`px-2 py-1 rounded text-[10px] font-mono border transition-all flex items-center gap-1.5 ${
                isSelected
                  ? "bg-cyan-600 text-[#252622] font-bold border-cyan-400 shadow-sm shadow-cyan-950"
                  : "bg-[#E9E5DA] hover:bg-[#E9E5DA] text-[#252622] border-[#D7D4CB]"
              }`}
            >
      ...
      {activeUnit && (
        <div className="rounded-md border border-[#D7D4CB] bg-[#E9E5DA] p-2.5 space-y-2 font-mono text-[10px]">
          <div className="flex items-center justify-between border-b border-[#D7D4CB] pb-1.5">
            <div>
              <span className="text-[#A85D48] font-bold">{activeUnit.unit_id}</span>
              <div className="text-[9px] text-[#62635D]">{activeUnit.unit_name || `Unit ${activeUnit.unit_number}`}</div>
            </div>
            <span
              className={`px-1.5 py-0.5 rounded text-[8px] font-bold border ${
                activeUnit.status === "VALID"
                  ? "bg-emerald-950/80 text-[#788575] border-emerald-500/40"
                  : "bg-[#F8F6F0]mber-950/80 text-amber-300 border-amber-500/40"
              }`}
            >
              {activeUnit.status}
            </span>
          ...
          <div className="grid grid-cols-2 gap-1.5 text-[#252622]">
            <div>
              <span className="text-[#77786F] block text-[9px]">PARENT FLOOR</span>
              <span className="text-[#B28A52]">{activeUnit.floor_id}</span>
            </div>
            <div>
              <span className="text-[#77786F] block text-[9px]">PARENT BUILDING</span>
              <span>{activeUnit.building_id}</span>
            </div>
            <div>
              <span className="text-[#77786F] block text-[9px]">Z-SPAN (AMSL)</span>
              <span>{activeUnit.base_elevation?.toFixed(2)}m – {activeUnit.top_elevation?.toFixed(2)}m</span>
            </div>
            <div>
              <span className="text-[#77786F] block text-[9px]">HEIGHT</span>
              <span className="text-[#A85D48] font-semibold">{activeUnit.height?.toFixed(2)}m</span>
            </div>
            <div>
              <span className="text-[#77786F] block text-[9px]">FOOTPRINT AREA</span>
              <span>{activeUnit.footprint_area?.toFixed(1)} m²</span>
            </div>
            <div>
              <span className="text-[#77786F] block text-[9px]">VOLUME</span>
              <span className="text-[#A85D48] font-bold">{activeUnit.volume_cubic_m?.toFixed(1)} m³</span>
            </div>
          </div>
          ...
          <div className="mt-2 rounded-lg border border-amber-500/50 bg-gradient-to-b from-amber-950/30 via-slate-900/90 to-[#0F1420] p-3 shadow-md space-y-2.5">
            <div className="flex items-center justify-between border-b border-amber-500/30 pb-2">
              <div className="flex items-center gap-2">
                <span className="flex h-5 w-5 items-center justify-center rounded bg-[#F8F6F0]mber-500/20 text-amber-400 font-mono font-bold text-[11px] border border-amber-500/40">
                  3D
                </span>
                <div>
                  ...
                  <p className="text-[9px] font-mono text-[#62635D]">
                    Cadastral Strata Title Entity · Metric 3D Geometry
                  </p>
                </div>
              </div>
              <span className="rounded bg-[#F8F6F0]mber-500/10 border border-amber-500/30 px-1.5 py-0.5 text-[8px] font-mono font-bold text-amber-300">
                PROTOTYPE
              </span>
            </div>

            {/* PPT Canonical Identity Chain & Reference Badge */}
            <div className="rounded bg-[#E9E5DA] border border-[#D7D4CB] p-2 font-mono text-[9px] space-y-1">
              <div className="flex items-center justify-between">
                <span className="text-[#77786F] uppercase tracking-wider text-[8px]">Property Record Reference:</span>
                <span className="text-amber-400 font-bold">
                  {unitPropertyRecord?.property_record_reference || "P001-B01-FL05-U501"}
                </span>
              </div>
              <div className="flex items-center justify-between text-[8px] text-[#62635D] border-t border-slate-900 pt-1">
                <span className="text-[#77786F] uppercase tracking-wider">Identity Chain:</span>
                <span className="text-[#A85D48]">
            ...
            <div className="grid grid-cols-2 gap-1.5 text-[10px] font-mono">
              <div className="rounded bg-[#E9E5DA] border border-[#D7D4CB] p-1.5">
                <span className="text-[#77786F] block text-[8px] uppercase">Cadastral Parcel</span>
                <span className="text-[#788575] font-bold truncate block" title={unitPropertyRecord?.parcel_id || activeUnit.parcel_id}>
              ...
              <div className="rounded bg-[#E9E5DA] border border-[#D7D4CB] p-1.5">
                <span className="text-[#77786F] block text-[8px] uppercase">Parent Building</span>
                <span className="text-[#B28A52] font-bold truncate block" title={unitPropertyRecord?.building_id || activeUnit.building_id}>
              ...
              <div className="rounded bg-[#E9E5DA] border border-[#D7D4CB] p-1.5">
                <span className="text-[#77786F] block text-[8px] uppercase">Floor Level</span>
                <span className="text-[#A85D48] font-bold truncate block" title={unitPropertyRecord?.floor_id || activeUnit.floor_id}>
              ...
              <div className="rounded bg-[#E9E5DA] border border-[#D7D4CB] p-1.5">
                <span className="text-[#77786F] block text-[8px] uppercase">Unit Entity ID</span>
              ...
              <div className="rounded bg-[#E9E5DA] border border-[#D7D4CB] p-1.5">
                <span className="text-[#77786F] block text-[8px] uppercase">Z-Range (AMSL)</span>
                <span className="text-[#252622] font-bold block">
                  {activeUnit.base_elevation?.toFixed(2)}m – {activeUnit.top_elevation?.toFixed(2)}m
                </span>
                <span className="text-[#62635D] block text-[8px]">Height: {activeUnit.height?.toFixed(2)}m</span>
              </div>
              <div className="rounded bg-[#E9E5DA] border border-[#D7D4CB] p-1.5">
                <span className="text-[#77786F] block text-[8px] uppercase">Property Volume</span>
                <span className="text-amber-400 font-bold block">
                  {unitPropertyRecord?.volume_cubic_m ?? activeUnit.volume_cubic_m?.toFixed(1) ?? "133.5"} m³
                </span>
                <span className="text-[#62635D] block text-[8px]">Footprint: {activeUnit.footprint_area?.toFixed(1)} m²</span>
              </div>
            </div>

            {/* Topology Status */}
            <div className="rounded bg-[#E9E5DA] border border-[#D7D4CB] p-2 text-[9px] font-mono flex items-center justify-between">
              <div>
                <span className="text-[#77786F] block text-[8px] uppercase">Topology Verification</span>
                <span className="text-[#252622] font-bold">
              ...
              <span className="flex items-center gap-1 text-[8px] font-bold text-[#788575] bg-emerald-950/60 border border-emerald-500/30 rounded px-1.5 py-0.5">
                ✓ MANIFOLD SOLID
              </span>
            </div>
            ...
            <div className="rounded bg-[#E9E5DA] border border-[#DDBCB4] p-2 space-y-1.5 font-mono text-[9px]">
              ...
              <div className="rounded bg-[#E9E5DA] border border-[#D7D4CB] p-1.5 text-[8px] text-[#A85D48] break-all select-all font-mono">
                {unitPropertyRecord?.ulpin_prototype ||
                  ulpins3D?.[activeUnit.property_id || activeUnit.unit_id]?.ulpin ||
                  "3DULPIN-V1-UNAVAILABLE"}
              </div>
              <div className="text-[7.5px] text-[#62635D] leading-tight">
            ...
            {/* Legal Disclaimer */}
            <div className="rounded bg-[#F8F6F0]mber-950/20 border border-amber-500/20 p-2 text-[8px] font-mono text-amber-400/90 leading-relaxed">
...
function ElevationCard({
  ...
  return (
    <div className="rounded-lg border border-[#D7D4CB] bg-[#E9E5DA] p-2.5">
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-1.5">
          <span className="h-2 w-2 rounded-full bg-[#F8F6F0]mber-400" />
          <span className="text-[10px] font-mono uppercase text-[#62635D] font-semibold tracking-wider">
            Ground Elevation (Z-Metric)
          </span>
        </div>
        {elevation && elevation.status === "SUCCESS" && (
          <span className="rounded bg-emerald-950/60 border border-emerald-500/30 px-1.5 py-0.5 text-[9px] font-mono text-[#788575]">
            DEM Sampled
          </span>
        )}
        {elevation && elevation.status === "OUTSIDE_COVERAGE" && (
          <span className="rounded bg-[#F8F6F0]mber-950/60 border border-amber-500/30 px-1.5 py-0.5 text-[9px] font-mono text-amber-400">
            Outside Bounds
          </span>
        )}
      ...
      {!elevation ? (
        <div className="flex flex-col gap-2 py-1">
          <div className="flex items-baseline justify-between">
            <span className="text-[#77786F] font-mono text-[11px]">Elevation (AMSL)</span>
            <span className="text-[#77786F] font-mono italic text-[11px]">Not available</span>
          </div>
          <p className="text-[10px] text-[#77786F] leading-relaxed">
          ...
          {onSample && (
            <button
              ...
              onClick={onSample}
              disabled={isSampling}
              className="mt-1 inline-flex items-center justify-center gap-1 rounded border border-amber-500/40 bg-[#F8F6F0]mber-950/30 px-2.5 py-1 text-[10px] font-mono font-medium text-amber-300 hover:bg-[#F8F6F0]mber-900/40 transition-colors disabled:opacity-50"
            >
              {isSampling ? (
                <>
        ...
        <div className="space-y-2">
          <div className="flex items-baseline justify-between border-b border-[#D7D4CB] pb-1.5">
            <div>
              <div className="text-lg font-bold font-mono text-amber-400">
                {elevation.elevation_m.toFixed(2)}{" "}
                <span className="text-xs font-normal text-[#62635D]">{elevation.vertical_unit}</span>
              </div>
              <div className="text-[10px] font-mono text-[#77786F]">
                Datum: {elevation.vertical_reference}
              </div>
            </div>
            <div className="text-right">
              <span className="text-[10px] font-mono text-[#77786F] block uppercase">Sample Method</span>
              <span className="text-[11px] font-mono text-[#252622] capitalize">{elevation.sampling_method}</span>
            </div>
          </div>

          <div className="grid grid-cols-2 gap-x-2 gap-y-1 text-[10px] font-mono pt-0.5">
            <div>
              <span className="text-[#77786F] block">Source Raster</span>
              <span className="text-[#252622] truncate block" title={elevation.source_dem}>
                {elevation.source_dem}
              </span>
            </div>
            <div>
              <span className="text-[#77786F] block">Raster CRS</span>
              <span className="text-[#252622] truncate block" title={elevation.dem_crs}>
                {elevation.dem_crs}
              </span>
            </div>
            <div className="col-span-2">
              <span className="text-[#77786F] block">Centroid Coordinates Sampled</span>
              <span className="text-[#62635D] truncate block">
        ...
        <div className="py-1">
          ...
          <div className="text-[10px] font-mono text-[#77786F] mt-1">
...
export function ParcelInspector({
  ...
  return (
    <div className="flex flex-col gap-3 p-4 text-xs font-sans">
      ...
      <div className="flex rounded-lg border border-[#D7D4CB] bg-[#E9E5DA] p-1 text-[11px] font-mono">
        <button
          type="button"
        ...
        <button
          ...
          className={`flex-1 rounded py-1 font-medium transition-colors ${
            activeTab === "building"
              ? "bg-purple-950/60 text-[#B28A52] border border-purple-500/30"
              : "text-[#62635D] hover:text-[#252622]"
          }`}
        >
        ...
        {units && units.length > 0 && (
          <button
            ...
            className={`flex-1 rounded py-1 font-medium transition-colors ${
              activeTab === "units"
                ? "bg-cyan-950/60 text-[#A85D48] border border-[#DDBCB4]"
                : "text-[#62635D] hover:text-[#252622]"
            }`}
          >
            Units ({units.length})
      ...
      {activeTab === "parcel" && (
        <>
          {!selectedParcel ? (
            <div className="flex flex-col items-center justify-center p-6 text-center text-[#62635D]">
              <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-xl border border-[#D7D4CB] bg-[#E9E5DA] text-[#77786F]">
              ...
              <h3 className="text-sm font-semibold text-[#252622]">No Parcel Selected</h3>
              <p className="mt-1 text-xs text-[#77786F] max-w-[220px]">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center justify-between border-b border-[#D7D4CB] pb-2">
                <div>
                  <span className="text-[10px] font-mono uppercase tracking-wider text-[#77786F]">
                    Cadastral Land Parcel
                  </span>
                  <div className="flex items-center gap-2 mt-0.5">
                    <h2 className="text-sm font-bold font-mono text-[#788575]">
                      {selectedParcel.parcel_id}
                    </h2>
                    {selectedParcel.is_system_generated_id ? (
                      <span className="rounded bg-[#F8F6F0]mber-950/40 border border-amber-500/30 px-1.5 py-0.5 text-[10px] font-mono text-amber-400">
                        System Assigned
                      </span>
                    ) : (
                      <span className="rounded bg-emerald-950/40 border border-emerald-500/30 px-1.5 py-0.5 text-[10px] font-mono text-[#788575]">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="rounded-lg border border-[#D7D4CB] bg-[#E9E5DA] p-2">
                  <div className="text-[10px] font-mono uppercase text-[#77786F]">Calculated Area</div>
                  <div className="mt-0.5 font-mono font-medium text-[#252622] truncate">
                ...
                <div className="rounded-lg border border-[#D7D4CB] bg-[#E9E5DA] p-2">
                  <div className="text-[10px] font-mono uppercase text-[#77786F]">Geometry Type</div>
                  <div className="mt-0.5 font-mono font-medium text-[#252622]">
                    {selectedParcel.geometry_type || "Not available"}
                  </div>
                </div>

                <div className="rounded-lg border border-[#D7D4CB] bg-[#E9E5DA] p-2">
                  <div className="text-[10px] font-mono uppercase text-[#77786F]">Coordinate System</div>
                  <div className="mt-0.5 font-mono font-medium text-[#252622] truncate" title={crs}>
                    {crs}
                  </div>
                </div>

                <div className="rounded-lg border border-[#D7D4CB] bg-[#E9E5DA] p-2">
                  <div className="text-[10px] font-mono uppercase text-[#77786F]">Centroid</div>
                  <div className="mt-0.5 font-mono font-medium text-[#252622] truncate">
              ...
              <div className="rounded-lg border border-[#D7D4CB] bg-[#E9E5DA] p-2.5">
                <div className="flex items-center justify-between mb-1.5">
                  <span className="text-[10px] font-mono uppercase text-[#62635D] font-semibold">
                    Associated Buildings
                  </span>
                  <span className="rounded bg-purple-950/60 border border-purple-500/30 px-1.5 py-0.5 text-[10px] font-mono text-[#B28A52]">
                    {associatedBuildingIds.length} Footprint{associatedBuildingIds.length === 1 ? "" : "s"}
                  </span>
                </div>

                {associatedBuildingIds.length === 0 ? (
                  <p className="text-[11px] text-[#77786F] italic">
              ...
              <div className="rounded-lg border border-[#D7D4CB] bg-[#E9E5DA] overflow-hidden">
                <div className="border-b border-[#D7D4CB] bg-[#E9E5DA] px-3 py-1 text-[10px] font-mono font-semibold uppercase tracking-wider text-[#62635D]">
                ...
                <div className="max-h-36 overflow-y-auto divide-y divide-slate-800/60">
                  {Object.entries(selectedParcel.properties).length === 0 ? (
                    <div className="p-2 text-[#77786F] italic">No additional properties provided.</div>
                  ) : (
                    Object.entries(selectedParcel.properties).map(([k, v]) => (
                      <div key={k} className="flex justify-between px-3 py-1 text-[11px] font-mono">
                        <span className="text-[#62635D] select-all">{k}</span>
                        <span className="text-[#252622] font-medium select-all text-right truncate max-w-[140px]" title={String(v)}>
        ...
        <>
          {!selectedBuilding ? (
            <div className="flex flex-col items-center justify-center p-6 text-center text-[#62635D]">
              ...
              <h3 className="text-sm font-semibold text-[#252622]">No Building Selected</h3>
              <p className="mt-1 text-xs text-[#77786F] max-w-[220px]">
            ...
            (() => {
              ...
              const statusBadgeColor =
                status === "WITHIN"
                  ? "bg-emerald-950/60 text-[#788575] border-emerald-500/40"
                  : status === "MULTI_PARCEL"
                  ? "bg-[#F8F6F0]mber-950/60 text-amber-300 border-amber-500/40"
                  : status === "OUTSIDE"
                  ? "bg-red-950/60 text-red-300 border-red-500/40"
                  : "bg-[#E9E5DA] text-[#252622] border-[#D7D4CB]";

              return (
                <div className="flex flex-col gap-3">
                  {/* Real OSM Non-Cadastral Disclaimer */}
                  {properties.source === "OpenStreetMap" && (
                    <div className="rounded-lg border border-amber-500/40 bg-[#F8F6F0]mber-950/30 p-2.5 text-[11px] font-mono text-amber-200 shadow-sm">
                  ...
                  <div className="flex items-center justify-between border-b border-[#D7D4CB] pb-2">
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        <h2 className="text-sm font-bold font-mono text-[#B28A52]">
                          {buildingId}
                        </h2>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="rounded-lg border border-[#D7D4CB] bg-[#E9E5DA] p-2">
                      <div className="text-[10px] font-mono uppercase text-[#77786F]">Footprint Area</div>
                      <div className="mt-0.5 font-mono font-medium text-[#252622]">
                        {areaText}
                      </div>
                    </div>
                    ...
                    <div className="rounded-lg border border-[#D7D4CB] bg-[#E9E5DA] p-2">
                      <div className="text-[10px] font-mono uppercase text-[#77786F]">Associated Parcel</div>
                      <div className="mt-0.5 font-mono font-medium text-[#252622]">
                        {associatedParcel !== "Not available" ? (
                          <button
                            ...
                            className="text-[#A85D48] hover:underline inline-flex items-center gap-1"
                          ...
                          <span className="text-[#77786F]">Not available</span>
                        )}
                      </div>
                    </div>

                    <div className="rounded-lg border border-[#D7D4CB] bg-[#E9E5DA] p-2">
                      <div className="text-[10px] font-mono uppercase text-[#77786F]">Overlap Ratio</div>
                      <div className="mt-0.5 font-mono font-medium text-[#252622]">
                        {overlapPct}
                      </div>
                    </div>
                    ...
                    <div className="rounded-lg border border-[#D7D4CB] bg-[#E9E5DA] p-2.5">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <button
                          type="button"
                          onClick={() => setUserSelectedTab("units")}
                          className="text-[10px] font-mono text-[#A85D48] hover:underline"
                        >
                          View All Units →
                        </button>
                      </div>
                          ...
                          <button
                            ...
                            className={`px-2 py-1 rounded text-[10px] font-mono border transition-colors ${
                              selectedUnitId === u.unit_id
                                ? "bg-[#F8F6F0]mber-950/60 border-amber-500 text-amber-300 font-bold"
                                : "bg-[#E9E5DA] border-[#D7D4CB] text-[#252622] hover:border-slate-500"
                            }`}
                          >
                  ...
                  {assoc && assoc.overlaps && assoc.overlaps.length > 1 && (
                    <div className="rounded-lg border border-amber-900/40 bg-[#F8F6F0]mber-950/20 p-2">
                      ...
                      <div className="space-y-1">
                        {assoc.overlaps.map((ov) => (
                          <div key={ov.parcel_id} className="flex justify-between text-[11px] font-mono">
                            <span className="text-[#252622]">{ov.parcel_id}</span>
      ...
      {activeTab === "summary" && (
        <div className="flex flex-col gap-3">
          {associationSummary && (
            <>
              <div className="border-b border-[#D7D4CB] pb-2">
                <span className="text-[10px] font-mono uppercase tracking-wider text-[#77786F]">
                  Spatial Intelligence Engine
                </span>
                <h2 className="text-sm font-bold font-mono text-[#A85D48] mt-0.5">
                  Topological Association Summary
                </h2>
              </div>

              <div className="grid grid-cols-2 gap-2 text-[11px] font-mono">
                <div className="rounded border border-[#D7D4CB] bg-[#E9E5DA] p-2">
                  <span className="text-[#77786F] block text-[10px]">Total Parcels</span>
                  <span className="text-[#252622] font-bold text-sm">{associationSummary.total_parcels}</span>
                </div>

                <div className="rounded border border-[#D7D4CB] bg-[#E9E5DA] p-2">
                  <span className="text-[#77786F] block text-[10px]">Total Buildings</span>
                  <span className="text-[#252622] font-bold text-sm">{associationSummary.total_buildings}</span>
                </div>
                ...
                <div className="rounded border border-emerald-900/50 bg-emerald-950/20 p-2">
                  ...
                  <span className="text-[#788575] font-bold text-sm">{associationSummary.associated_buildings}</span>
                </div>

                <div className="rounded border border-amber-900/50 bg-[#F8F6F0]mber-950/20 p-2">
                ...
                <div className="rounded border border-[#D7D4CB] bg-[#E9E5DA] p-2">
                  <span className="text-[#77786F] block text-[10px]">Metric Projected CRS</span>
                  <span className="text-[#252622] font-medium">{associationSummary.projected_crs}</span>
                </div>
              </div>
            </>
          )}
          ...
          {demMetadata && (
            <div className="flex flex-col gap-2 pt-2 border-t border-[#D7D4CB]">
              <div className="border-b border-[#D7D4CB] pb-1.5">
                <div className="flex items-center gap-1.5">
                  <span className="h-2 w-2 rounded-full bg-[#F8F6F0]mber-400" />
                  <span className="text-[10px] font-mono uppercase tracking-wider text-[#77786F] font-semibold">
              ...
              <div className="grid grid-cols-2 gap-2 text-[11px] font-mono">
                <div className="rounded border border-[#D7D4CB] bg-[#E9E5DA] p-2">
                  <span className="text-[#77786F] block text-[10px]">Raster Grid</span>
                  <span className="text-[#252622] font-semibold text-xs">
                    {demMetadata.width} × {demMetadata.height} px
                  </span>
                </div>

                <div className="rounded border border-[#D7D4CB] bg-[#E9E5DA] p-2">
                  <span className="text-[#77786F] block text-[10px]">Format / CRS</span>
                  <span className="text-[#252622] font-semibold text-xs truncate" title={demMetadata.crs}>
                    {demMetadata.crs}
                  </span>
                </div>

                <div className="rounded border border-amber-900/40 bg-[#F8F6F0]mber-950/20 p-2 col-span-2">
                  ...
                  <div className="flex justify-between items-baseline mt-0.5">
                    ...
                    <span className="text-[#62635D] text-[10px]">
                ...
                <div className="rounded border border-[#D7D4CB] bg-[#E9E5DA] p-2">
                  <span className="text-[#77786F] block text-[10px]">NoData Sentinel</span>
                  <span className="text-[#62635D] text-xs">
                    {demMetadata.nodata_value !== null ? String(demMetadata.nodata_value) : "None"}
                  </span>
                </div>

                <div className="rounded border border-[#D7D4CB] bg-[#E9E5DA] p-2">
                  <span className="text-[#77786F] block text-[10px]">Vertical Reference</span>
                  <span className="text-[#252622] text-xs truncate" title={demMetadata.vertical_reference}>
