...
export function UndergroundDataCard() {
  ...
  return (
    <div className="rounded-xl border border-[#D7D4CB] bg-[#E9E5DA] p-6 shadow-xl backdrop-blur space-y-6">
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#D7D4CB] pb-4">
        <div>
          <div className="flex items-center gap-2.5">
            <span className="text-xl">🕳️</span>
            <h2 className="text-lg font-semibold text-[#252622] tracking-wide">
              Underground & Subsurface Spatial Modeling
            </h2>
            <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-mono font-medium bg-cyan-950/80 text-[#A85D48] border border-cyan-800/60">
              Step 20 • Subsurface Layer
            </span>
          </div>
          <p className="text-xs text-[#62635D] mt-1">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            disabled={isLoading}
            className="px-3.5 py-1.5 rounded-lg text-xs font-medium bg-cyan-600 hover:bg-cyan-500 text-[#252622] transition-colors disabled:opacity-50 flex items-center gap-1.5 shadow-sm"
          >
            {isLoading ? "Loading..." : "Load Demo Subsurface"}
          </button>
          <Link
            href="/workspace/3d"
            className="px-3 py-1.5 rounded-lg text-xs font-medium bg-[#E9E5DA] hover:bg-slate-700 text-[#252622] transition-colors border border-[#D7D4CB] flex items-center gap-1.5"
          >
            Inspect in 3D ↗
          </Link>
        </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div className="p-3 rounded-lg bg-[#E9E5DA] border border-[#D7D4CB]">
          <div className="text-[10px] font-mono uppercase tracking-wider text-[#62635D]">
            Registered Subsurface
          </div>
          <div className="text-lg font-bold text-[#252622] mt-0.5">
            {bundle ? `${bundle.total_features} Assets` : "—"}
          </div>
          <div className="text-[10px] text-[#62635D] mt-0.5">DEMO-401/1 Testbed</div>
        </div>
        ...
        <div className="p-3 rounded-lg bg-[#E9E5DA] border border-[#D7D4CB]">
          ...
          <div className="text-lg font-bold text-[#788575] mt-0.5">
            {bundle ? "920.0 m" : "—"}
          </div>
          <div className="text-[10px] text-[#788575]/80 mt-0.5">EGM2008 / AMSL Datum</div>
        </div>
      </div>
      ...
      {bundle && (
        <div className="space-y-4">
          <div className="flex flex-wrap gap-2 border-b border-[#D7D4CB] pb-3">
              ...
              return (
                <button
                  ...
                  className={`px-3 py-2 rounded-lg text-left transition-all border text-xs ${
                    isSelected
                      ? "bg-[#E9E5DA] border-cyan-500/80 text-[#252622] shadow-md shadow-cyan-950/30 ring-1 ring-cyan-500/30"
                      : "bg-[#E9E5DA] border-[#D7D4CB] text-[#62635D] hover:text-[#252622] hover:border-[#D7D4CB]"
                  }`}
                >
                  <div className="flex items-center gap-1.5">
                    <span className={`w-2 h-2 rounded-full ${isBasement ? "bg-[#F3F0E8]lue-400" : "bg-[#F8F6F0]mber-400"}`} />
                    <span className="font-mono font-semibold">{feat.underground_feature_id}</span>
                  </div>
                  <div className="text-[11px] truncate max-w-[190px] mt-0.5 text-[#252622]">
                    {feat.name}
                  </div>
                  <div className="text-[10px] font-mono text-[#62635D] mt-1">
          ...
          {selectedFeature && (
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pt-2">
              ...
              <div className="lg:col-span-2 space-y-4">
                ...
                <div
                  className={`p-3.5 rounded-lg border text-xs leading-relaxed ${
                    selectedFeature.is_cadastral_property
                      ? "bg-[#F3F0E8]lue-950/30 border-blue-800/60 text-blue-200"
                      : "bg-[#F8F6F0]mber-950/30 border-amber-800/60 text-amber-200"
                  }`}
                >
                  <div className="font-semibold flex items-center gap-2">
                    {selectedFeature.is_cadastral_property ? (
                      <>
                        ...
                        <span className="px-1.5 py-0.2 rounded bg-[#F3F0E8]lue-900/60 text-[10px] text-blue-300 font-mono">
                          Eligible for Title
                        </span>
                      </>
                    ) : (
                      <>
                        ...
                        <span className="px-1.5 py-0.2 rounded bg-[#F8F6F0]mber-900/60 text-[10px] text-amber-300 font-mono">
                ...
                <div className="p-4 rounded-lg bg-[#E9E5DA] border border-[#D7D4CB] space-y-3">
                  <div className="text-xs font-semibold text-[#252622] uppercase font-mono tracking-wider">
                    Elevation & Depth Coordinate Mathematics (Z-Up Convention)
                  </div>
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 font-mono text-xs">
                    <div className="p-2.5 rounded bg-[#E9E5DA] border border-[#D7D4CB]">
                      <span className="text-[#62635D] block text-[10px]">Reference Ground (Z_ground)</span>
                      <span className="text-[#252622] font-bold text-sm">
                        {selectedFeature.ground_elevation_m.toFixed(2)} m ASL
                      </span>
                    </div>
                    <div className="p-2.5 rounded bg-[#E9E5DA] border border-[#D7D4CB]">
                      <span className="text-[#62635D] block text-[10px]">Top Elevation (Z_top)</span>
                      <span className="text-[#A85D48] font-bold text-sm">
                        {selectedFeature.top_elevation_m.toFixed(2)} m ASL
                      </span>
                    </div>
                    <div className="p-2.5 rounded bg-[#E9E5DA] border border-[#D7D4CB]">
                      <span className="text-[#62635D] block text-[10px]">Base Elevation (Z_base)</span>
                      <span className="text-[#A85D48] font-bold text-sm">
                        {selectedFeature.base_elevation_m.toFixed(2)} m ASL
                      </span>
                    </div>
                    <div className="p-2.5 rounded bg-[#E9E5DA] border border-[#D7D4CB]">
                      <span className="text-[#62635D] block text-[10px]">Depth to Top (Z_g - Z_t)</span>
                      <span className="text-[#788575] font-bold text-sm">
                        {selectedFeature.depth_to_top_m.toFixed(2)} m
                      </span>
                    </div>
                    <div className="p-2.5 rounded bg-[#E9E5DA] border border-[#D7D4CB]">
                      <span className="text-[#62635D] block text-[10px]">Depth to Base (Z_g - Z_b)</span>
                      <span className="text-[#788575] font-bold text-sm">
                        {selectedFeature.depth_to_base_m.toFixed(2)} m
                      </span>
                    </div>
                    <div className="p-2.5 rounded bg-[#E9E5DA] border border-[#D7D4CB]">
                      <span className="text-[#62635D] block text-[10px]">Solid Thickness (Z_t - Z_b)</span>
                      <span className="text-[#788575] font-bold text-sm">
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    disabled={isLoading}
                    className="px-3 py-2 rounded-lg text-xs font-medium bg-[#E9E5DA] hover:bg-slate-700 text-[#252622] border border-[#D7D4CB] transition-colors"
                  >
                  ...
                  <button
                    ...
                    disabled={isLoading}
                    className="px-3 py-2 rounded-lg text-xs font-medium bg-indigo-600 hover:bg-indigo-500 text-[#252622] transition-colors"
                  >
                ...
                {validationResult && (
                  ...
                  >
                    <div className="font-semibold flex items-center gap-2">
                      ...
                      <span className="font-mono text-[10px] uppercase px-1.5 py-0.5 rounded bg-[#E9E5DA]">
                ...
                {conflictResult && (
                  <div className="p-3.5 rounded-lg bg-[#E9E5DA]/70 border border-[#D7D4CB] text-xs space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="font-semibold text-[#252622]">
                      ...
                      <span
                        className={`px-2 py-0.5 rounded text-[10px] font-mono ${
                          conflictResult.has_invalid_clash
                            ...
                            : "bg-emerald-950 text-[#788575] border border-emerald-800"
                        }`}
                      >
                        {conflictResult.has_invalid_clash ? "Physical Clash Detected" : "No Unresolved Clashes"}
                      </span>
                    </div>
                    <p className="text-[11px] text-[#62635D]">{conflictResult.summary_message}</p>
                    {conflictResult.conflicts.map((c, idx) => (
                      <div
                        key={idx}
                        className="p-2.5 rounded bg-[#E9E5DA] border border-[#D7D4CB] space-y-1 font-mono text-[11px]"
                      >
                        <div className="flex items-center justify-between text-[#252622]">
                          <span>
                          ...
                          <span
                            className={`px-1.5 py-0.2 rounded text-[10px] ${
                              c.conflict_class === "ALLOWED_INTERSECTION"
                                ? "bg-[#F3F0E8]lue-900/60 text-blue-300"
                                : c.conflict_class === "REVIEW_REQUIRED"
                                ? "bg-[#F8F6F0]mber-900/60 text-amber-300"
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-lg bg-[#E9E5DA] border border-[#D7D4CB] space-y-2.5">
                  <div className="text-xs font-semibold text-[#252622] uppercase font-mono tracking-wider">
                    Survey & Provenance
                  </div>
                  <div className="space-y-1.5 text-xs text-[#252622]">
                    <div>
                      <span className="text-[#77786F] block text-[10px]">Source Dataset:</span>
                      <span className="font-mono text-[11px]">{selectedFeature.provenance.source_dataset}</span>
                    </div>
                    <div>
                      <span className="text-[#77786F] block text-[10px]">Survey Method:</span>
                      <span className="text-[11px]">{selectedFeature.provenance.survey_method || "Direct As-built"}</span>
                    </div>
                    <div>
                      <span className="text-[#77786F] block text-[10px]">Horizontal CRS:</span>
                      <span className="font-mono text-[11px]">{selectedFeature.provenance.crs}</span>
                    </div>
                    <div>
                      <span className="text-[#77786F] block text-[10px]">Vertical Datum:</span>
                      <span className="font-mono text-[11px]">{selectedFeature.provenance.vertical_datum}</span>
                    </div>
                    <div>
                      <span className="text-[#77786F] block text-[10px]">3D Geometry Status:</span>
                      <span className="font-mono text-[11px] text-[#788575] font-semibold">
                ...
                <div className="p-3.5 rounded-lg bg-[#E9E5DA] border border-[#D7D4CB] text-[11px] text-[#62635D] leading-relaxed">
                  <span className="font-semibold text-[#252622] block mb-1">Cadastral Compliance Note:</span>
