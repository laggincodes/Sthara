...
| 13 | **3D ULPIN (Spatial Hash)** | **FULLY IMPLEMENTED** | Deterministic versioned 3D spatial hash (`3DULPIN-V1-<64_HEX>`) generated via SHA-256 over normalized cadastral entity components (parcel, building, floor, property ID) in `backend/app/services/ulpin_service.py` | Computed deterministically from Canonical 3D Unit Volumes | **RESEARCH PROTOTYPE**: Derived spatial hash; not an official government-issued land registration. |
...
| 17 | **Canonical Demo Property** | **FULLY IMPLEMENTED** | Authoritative strata hierarchy: Parcel P001 -> Building B01 -> Floor 05 -> Unit 501 (`/api/v1/units/canonical-demo`) | Linked demo fixtures with metric 3D coordinates | Volume: 133.5 m³, Z: 577.48m–580.48m AMSL, Status: VALID, Property Record Reference: `P001-B01-FL05-U501`, Prototype ULPIN: `3DULPIN-V1-B275000C2857E6067901B3429CBA56FA7F96B322BAC19BB985025695B924D657`. |
...
2. In the inspector card on the right, observe the **3D Property Record**:
   ...
   - **Property Record Reference**: `P001-B01-FL05-U501` (Identity Chain: `P001 → B01 → F05 → U501`)
   - **Prototype ULPIN**: `3DULPIN-V1-B275000C2857E6067901B3429CBA56FA7F96B322BAC19BB985025695B924D657` labeled **3D ULPIN PROTOTYPE (RESEARCH IMPLEMENTATION)**
